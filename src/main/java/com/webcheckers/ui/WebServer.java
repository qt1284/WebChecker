...
public class WebServer {
  ...
  public void initialize() {
    ...
    post(HOME_URL,new PostHomeRoute(templateEngine,playerLobby,gameCenter));
    ...
    get(SPECTATOR_GAME_URL, new GetSpectatorGameRoute(templateEngine,gameCenter,playerLobby));
    get(SPECTATOR_STOP_WATCHING_URL, new GetSpectatorStopWatchingRoute(templateEngine,playerLobby,gameCenter));
    post(VALIDATE_MOVE_URL, new PostValidateMoveRoute(gameCenter));
    ...
    post(RESIGN_GAME_URL,new PostResignGame(gameCenter));
    post(SIGN_OUT_URL,new PostSignOutRoute(templateEngine,playerLobby,gameCenter));
    post(SPECTATOR_CHECK_TURN_URL,new PostSpectatorCheckTurnRoute(templateEngine,gameCenter,playerLobby));
